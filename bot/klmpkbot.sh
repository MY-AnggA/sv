...
wget https://raw.githubusercontent.com/MY-AnggA/sv/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
wget https://raw.githubusercontent.com/MY-AnggA/sv/main/bot/regis.zip
unzip regis.zip
rm -rf regis.zip
...
echo -e "${grenbo}[*] Bot By MY-ANGGA${NC}"
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
[Unit]
Description=Simple register - @anggaalfarizi
