...
checking_sc
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO MY-ANGGA TUNNELING SCRIPT ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}ANGGA ALFARIZI® ${NC}${YELLOW}(${NC}${green}V 3.2${NC}${YELLOW})${NC}"
echo -e " ›TEAM 🅥🅝: MY-AnggA ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/MY-AnggA/sv/main/"
...
TIMES="10"
CHATID="-5196612474"
KEY="7032109934:AAESPInlG5Kp5sHl6QSh5BIIqogPx8cXjUY"
...
<code>────────────────────</code>
<b> ANGGA ALFARIZI SCRIPT  </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/anggaalfarizi"}]]}' 
...
wget -q https://raw.githubusercontent.com/MY-AnggA/sv/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY ANGGA  ALFARIZI ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "BERHASIL INSTALL SC NYA CUY..."
sleep 1
