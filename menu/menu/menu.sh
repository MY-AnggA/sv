...
echo ""
izinsc="https://anggaalfarizi.tips/data.txt"
# USERNAME
rm -f /usr/bin/user
...
let ssa=$ssx/2
nob=$(grep -o "expired" "/etc/noobzvpns/users.json" | wc -l)
# //
r="\033[1;31m"  # merah
a="ACCOUNT PREMIUM" 
BWC='\033[1;36'
...
echo -e " "                                                           
echo -e " ${NC} ╭════════════════════════════════════════════════════════════════╮${NC}" |lolcat
echo -e " ${NC} │${purple}\033[1;95m                WELCOME TO SCRIPT KENTANG 🥔            ${NC}"
echo -e " ${NC} ╰════════════════════════════════════════════════════════════════╯"
echo -e " ${NC} ╭════════════════════════════════════════════════════════════════╮"
...
echo -e "               ${BRED} SHADOW/WS/GRPC   $YELL=$NC $ssx  ${YELL}$a"
echo -e "               ${BRED} SSH/NOOBZVPN     $YELL=$NC $nob  ${YELL}$a"
echo -e " ${NC}         ══════════════════════════════════════════════════${NC}" | lolcat
echo -e " ${NC}                  >>> Jangan Putus Asa Tetap Menyerah :) <<<"
echo -e " ${NC} ╭════════════════════╮╭════════════════════╮╭════════════════════╮$NC"
...
echo -e " ${NC} │$NC [${BRED}03$NC]${YELL} VLESS MENU   $NC│ [${BRED}09$NC]${YELL} RESTART ALL   $NC│ [${BRED}15$NC]${YELL} FIX CROT DOMAIN  ${NC}│"   
echo -e " ${NC} │$NC [${BRED}04$NC]${YELL} TROJAN MENU  $NC│ [${BRED}10$NC]${YELL} TELE BOT      $NC│ [${BRED}16$NC]${YELL} MENU NGANU       ${NC}│" 
echo -e " ${NC} │$NC [${BRED}05$NC]${YELL} SHADOWSOCKS  $NC│ [${BRED}11$NC]${YELL} UPDATE SCRIPT $NC│ [${BRED}17$NC]${YELL} TRIAL ACC        ${NC}│"
echo -e " ${NC} │$NC [${BRED}06$NC]${YELL} NOOBZVPN     $NC│ [${BRED}12$NC]${YELL} RUNNING       $NC│ [${BRED}18$NC]${YELL} SPEEDTEST        ${NC}│"
echo -e " ${NC} │                                                                ${NC}│"
echo -e " ${NC} ╰════════════════════════════════════════════════════════════════╯${NC}"
echo -e " ${NC} ╭════════════════════════════════════════════════════════════════╮${NC}" | lolcat
echo -e " ${NC} │$bblue Orang Ganteng  $YELL=$NC ANGGA ALFARIZI"
...
11)
clear
wget -q https://raw.githubusercontent.com/MY-AnggA/sv/main/kunyuk.sh
chmod +x kunyuk.sh
./kunyuk.sh
;;
12)
